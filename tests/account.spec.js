...
test.describe.serial("Account", () => {
  ...
  test("[ACCOUNT-001] account-sign-up", async ({ page }) => {
    ...
    await page
      .locator('xpath=//*[@id="main"]/div/div[2]/div[2]/div[1]/div/div[2]/div[1]/input')
      .fill(email);
    await page.waitForTimeout(latency);
    ...
    await page1.waitForTimeout(latency);
    await page1.locator('xpath=//*[@id=":2m"]')
    .click();
    ...
    //여기가 중간 지점
    await page.locator('xpath=//*[@id="main"]/div/div[2]/div[2]/div[2]/div/div[2]/div[1]/input')
    .fill(match);

    //여기부터 다시 시작
    await page.locator('xpath=//*[@id="main"]/div/div[2]/div[2]/div[3]/div/div[2]/div/input')
    .fill(password);
    await page.locator('xpath=//*[@id="main"]/div/div[2]/div[2]/div[4]/div/div[2]/div/input')
    .fill(password);
    ...
    await page.screenshot({
      path: screenshot_path("account", "account-sign-up", "2-account-sign-up-success" ),
      fullPage: true,
    });
    await expect(page)
    .toHaveURL('https://voice-korea.dev.biyard.co');
  ...
  test("[ACCOUNT-002] account-login", async ({ page }) => {
    ...
    await page
    .locator('xpath=//*[@id="main"]/div/div[2]/div[1]/div[1]/div[2]/div/div[2]/div/div')
    .click();
    await page.waitForNavigation();
    await page.screenshot({
