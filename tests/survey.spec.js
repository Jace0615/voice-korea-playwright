...
test.describe("Survey", () => {
  ...
  .click();
    ...
    // await page.locator(`.calendar-day-${todayDay}`).click();

    // await page.locator('xpath=//*[@id="main"]/div[2]/div[2]/div[2]/div[2]/div/div[3]/div[1]/div[1]/div[2]/div[3]/div[1]/button/div[text()="${todayDay}"]'
    // ).click();
...
//현재 가능한 테스트 리스트
// 1. 여론조사 (Survey Management)
//   1. 여론조사 생성 (Make survey)
//   2. 질문 추가
//   3. 패널 지정
//   4. 패널 선택
